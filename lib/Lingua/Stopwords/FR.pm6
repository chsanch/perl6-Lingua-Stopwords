...
sub get-list ( Str $list = 'snowball' ) is export {
    ...
    given $list {
        when 'all' {
            @word-list = <  ai aie aient aies ait alors as au aucuns aura aurai auraient aurais aurait auras aurez auriez aurions aurons auront aussi autre 
        ...
        when 'ranks-nl' {
            @word-list = <  alors au aucuns aussi autre avant avec avoir bon car ce cela ces ceux chaque ci comme comment dans dedans dehors depuis des 
                            ...
                            tous tout trop très tu voient vont votre vous vu ça étaient état étions été être >;
        }
        when 'snowball' {
            @word-list = <  ai aie aient aies ait as au aura aurai auraient aurais aurait auras aurez auriez aurions aurons auront aux avaient avais avait 
                            ...
                            était étant étiez étions été étée étées étés êtes >;
        }
        default {
