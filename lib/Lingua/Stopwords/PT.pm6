...
sub get-list ( Str $list = 'snowball' ) is export {
    ...
    given $list {
        when 'all' {
            @word-list = <  a abbia abbiamo abbiano abbiate ad adesso agl agli ai al all alla alle allo allora altre altri altro 
                            ...
                            un una uno va vai vi voi volte vostra vostre vostri vostro è >;
        }
        when 'ranks-nl' {
            @word-list = <  a adesso ai al alla allo allora altre altri altro anche ancora avere aveva avevano ben buono che chi 
        ...
        when 'snowball' {
            @word-list = <  ad al allo ai agli all agl alla alle con col coi da dal dallo dai dagli dall dagl dalla dalle di del 
                            ...
                            stesti stette stemmo steste stettero stessi stesse stessimo stessero stando >;
        }
        default {
