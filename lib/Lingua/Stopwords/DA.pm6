...
sub get-list ( Str $list = 'snowball' ) is export {
    ...
    given $list {
        when 'all' {
            @word-list = <  ad af alle alt anden andet andre at begge blev blive bliver da de dem den denne der deres det dette dig din disse dog du efter ej 
        ...
        when 'ranks-nl' {
            @word-list = <  af alle andet andre at begge da de den denne der deres det dette dig din dog du ej eller en end ene eneste enhver et fem fire 
                            ...
                            nyt nær næste næsten og op otte over på se seks ses som stor store syv ti til to tre ud var >;
        }
        when 'snowball' {
            @word-list = <  ad af alle alt anden at blev blive bliver da de dem den denne der deres det dette dig din disse dog du efter eller en end er et 
                            ...
                            var vi vil ville vor være været >;
        }
        default {
