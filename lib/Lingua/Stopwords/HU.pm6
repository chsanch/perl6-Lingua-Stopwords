...
sub get-list ( Str $list = 'snowball' ) is export {
    ...
    given $list {
        when 'all' {
            @word-list = <  a abban ahhoz ahogy ahol aki akik akkor alatt amely amelyek amelyekben amelyeket amelyet amelynek ami amikor amit amolyan amíg 
                            ...
                            õk õket ön össze úgy új újabb újra >;
        }
        when 'ranks-nl' {
            @word-list = <  a az egy be ki le fel meg el át rá ide oda szét össze vissza de hát és vagy hogy van lesz volt csak nem igen mint én te õ mi ti õk 
                            ön >;
        }
        when 'snowball' {
            @word-list = <  a ahogy ahol aki akik akkor alatt által általában amely amelyek amelyekben amelyeket amelyet amelynek ami amit amolyan amíg amikor 
                            ...
                            utolsó vagy vagyis valaki valami valamint való vagyok van vannak volt voltam voltak voltunk vissza vele viszont volna >;
        }
        default {
